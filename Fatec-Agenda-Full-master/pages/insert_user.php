...
$nome_usuario = utf8_decode(trim($nome_usuario));
$email = trim($email);
$senha = trim($senha);
...
if (!empty($erros))
{
    echo "
        ...
        <html>
            <head>
                 <!-- <META http-equiv=\"refresh\" content=\"0;URL=http://agenda-full.local/pages/register.php\"> -->
            </head>
            <body onload=\"alerta();\">
            </body>
        </html>
...
$sql = "insert into tbl_usuarios (nome_usuario, email, senha) values(\"$nome_usuario\", \"$email\", \"$senha\")";
...
<html>
    <head>
        <META http-equiv="refresh" content="1;URL=http://localhost:8088/Fatec-Agenda-Full-master/pages/login.php">
    </head>
</html>