...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://localhost:8088/Fatec-Agenda-Full-master">
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="cad-contato.php">Contatos</a>
                            <ul>
                                <li><a href="cad-contatos.php">Incluir</a></li>
                                <li><a href="lista-contatos.php">Listagem</a></li>
                            </ul>
                        </li>
                    </ul>
