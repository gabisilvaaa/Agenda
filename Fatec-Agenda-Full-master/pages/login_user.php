...
if (!empty($erros))
{
    ...
    echo "<br><br><a href='http://agenda-full.local/pages/login.php'>Clique aqui para voltar</a>";
}
...
if ($nro_registros == 0) {
    ...
    <html>
    <head>
        <META http-equiv=\"refresh\" content=\"0;URL=http://localhost:8088/Fatec-Agenda-Full-master/pages/login.php\">
    </head>
</html>
    ";
} else {
    ...
    <html>
    <head>
        <META http-equiv=\"refresh\" content=\"0;URL=http://localhost:8088/Fatec-Agenda-Full-master/pages/dashboard.php\">
    </head>
</html>
    ";
}
